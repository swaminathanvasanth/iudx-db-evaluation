...
public class APIServer extends AbstractVerticle {
	...
	public void start() throws Exception {
		...
		server = vertx.createHttpServer(new HttpServerOptions().setSsl(true).setClientAuth(clientAuth)
	...
	private void publishEvent(String event, JsonObject requested_data, DeliveryOptions options,
